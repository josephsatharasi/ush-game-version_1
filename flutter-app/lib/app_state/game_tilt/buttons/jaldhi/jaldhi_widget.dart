...
class GameTiltJaldhiWidget extends StatefulWidget {
  const GameTiltJaldhiWidget({super.key});

  @override
  State<GameTiltJaldhiWidget> createState() => _GameTiltJaldhiWidgetState();
}

class _GameTiltJaldhiWidgetState extends State<GameTiltJaldhiWidget> {
  int _currentPage = 0;
  final int _totalPages = 3;
  final Set<int> _selectedNumbers = {3, 7, 12, 18, 27}; // Jaldhi numbers
  final GameStateManager _gameState = GameStateManager();

  @override
  void initState() {
    super.initState();
    _gameState.markAsVisited('JALDHI');
  }
             ...
             // Student offer banner and Numbers button
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(context, '/fam-playground', arguments: 'JALDHI');
                          },
                          child: Container(
  ...
  Widget _buildGameTypeButtons() {
    return Column(
      children: [
        ...
        Row(
          children: [
            Expanded(child: _buildGameButton('JALDHI', Color(0xFFF59E0B), '5', true)),
            SizedBox(width: 10),
