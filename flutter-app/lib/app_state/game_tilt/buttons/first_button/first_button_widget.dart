...
class GameTiltFirstButtonWidget extends StatefulWidget {
  const GameTiltFirstButtonWidget({super.key});

  @override
  State<GameTiltFirstButtonWidget> createState() => _GameTiltFirstButtonWidgetState();
}
  ...
  Widget _buildGameTypeButtons() {
    return Column(
      children: [
        Row(
          children: [
            Expanded(child: _buildGameButton('FIRST LINE', Color(0xFF1E40AF), '1', true)),
            SizedBox(width: 10),
